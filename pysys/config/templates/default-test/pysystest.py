...
#__pysys_modes__            = lambda helper: helper.combineModeDimensions(helper.inheritedModes, helper.makeAllPrimary(
#		{'MyParameterizedSubtestModeA':{'MyParam':123}, 'MyParameterizedSubtestModeB':{'MyParam':456}, }))
