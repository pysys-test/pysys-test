...
from the `pysys.writer.TestOutputArchiveWriter` directory. 

If you want to implement additional functionality for your 
CI provider, subclass `pysys.writer.BaseRecordResultsWriter` (using the classes in this module as an example), and 
