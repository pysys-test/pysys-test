...
__pysys_traceability_ids__ = "UserRequirement_1a, UserRequirement_2c, Performance, UserStory.XYZ-54321"
...
__pysys_user_data__ = {'myTestDescriptorData': 'foobar', 'myTestDescriptorPath': 'foo/foo-${os_myThirdPartyLibraryVersion}\n\t\t\tfoo/bar, foo/baz\n\t\t\t\n\t\t\tfoo/bosh'}

__pysys_skipped_reason__   = "This test is skipped until Bug-1234 is fixed"

# Comments copied from pysystest.xml (but original position of comments not retained):
