...
def upgradeMain(args):
	...
	if (options and not dryrun) or len(args) != 2: 
		...
		print('Usage:')
		print('test_upgrader.py [--dry-run] "DELETE CMD" "RENAME CMD"')
		print('')
		print('For example:')
		print('   test_upgrader.py "rm" "mv"')
		print('   test_upgrader.py "del" "move"')
		print('   test_upgrader.py "svn rm" "svn mv"')
		print('   test_upgrader.py "git rm" "git mv"')
		print('')
